        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-24">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 bg-white/10 rounded-full flex items-center justify-center text-[#f4a261]">
                {stat.icon}
              </div>
