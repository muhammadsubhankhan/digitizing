            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-5 p-5 bg-[#f8f9fa] rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">c-5 Wilma Street, Amarillo City, Texas</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-5 p-5 bg-[#f8f9fa] rounded-2xl">
                  ...
                  <div>
                    ...
                    <a href={`tel:${CONTACT.phoneHref}`} className="text-gray-600 hover:text-[#e63946] transition-colors">{CONTACT.phone}</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-5 p-5 bg-[#f8f9fa] rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@custompatchhouse.com</p>
                  </div>
                </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex gap-3">
                  ...
                  <a href={`https://wa.me/${CONTACT.whatsapp}`} target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#25d366] text-white rounded-xl flex items-center justify-center hover:opacity-80 transition-opacity">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
